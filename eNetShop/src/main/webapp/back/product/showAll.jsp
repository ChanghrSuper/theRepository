            ...
            columns:[[
                ...
                {title:'标签',field:'tags',width:250,sortable:true,
                    formatter: function(value,row,index){
						...
						return tags+"<a href='javascript:;' class='btn' onClick=\"openAddTag('"+ row.id +"');\"  data-options=\"iconCls:'icon-remove'\" >添加</a>&nbsp;&nbsp;<a data-options=\"iconCls:'icon-edit'\" href='javascript:;' class='btn' onClick=\"openDelTag('"+ row.id +"');\"  >删除</a>";
                    }
				},
...
<div id="tb">
	...
	<a href="${pageContext.request.contextPath}/product/outPutProductAsExcel" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">Excel下载</a>
</div>

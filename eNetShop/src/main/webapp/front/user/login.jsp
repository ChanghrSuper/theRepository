            ...
            $("#loginform").form({
                ...
                success:function(data){
                    ...
                    if(result.status==true){
                        location.href='${pageContext.request.contextPath}/front/main/main.jsp';
                    }else {
                        $.messager.show({
                            title: '登录错误',
                            msg: result.message,
...
<body>
    ...
    <div align="center" style="margin-top: 100px">
        ...
        <form id="loginform" method="post">
            ...
            &nbsp;&nbsp;&nbsp;
            <a id="regist" href="javascript:;" class="easyui-linkbutton" onclick="location='${pageContext.request.contextPath}/front/user/regist.jsp'" data-options="iconCls:'icon-attach'">注册</a>

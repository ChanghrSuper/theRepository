...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            $.get("${pageContext.request.contextPath}/front/main/menu.json",function (menus) {
                //遍历一级菜单
...
<!-- 页面的头部分 -->
<div data-options="region:'north',split:false,href:'${pageContext.request.contextPath }/front/main/header.jsp'" style="height:100px;"></div>

<!-- 页面的尾部 -->
<div data-options="region:'south',split:false,href:'${pageContext.request.contextPath }/front/main/footer.jsp'" style="height:80px;"></div>

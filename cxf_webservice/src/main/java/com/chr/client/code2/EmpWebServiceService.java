 ...
 * 
 */
@WebServiceClient(name = "EmpWebServiceService", targetNamespace = "http://service.web.server.chr.com/", wsdlLocation = "http://localhost:8888/cxf_webservice/cxf/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPWEBSERVICESERVICE_QNAME = new QName("http://service.web.server.chr.com/", "EmpWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/cxf_webservice/cxf/ws?wsdl");
    ...
    public EmpWebService getEmpWebServicePort() {
        return super.getPort(new QName("http://service.web.server.chr.com/", "EmpWebServicePort"), EmpWebService.class);
    }
    ...
    public EmpWebService getEmpWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.web.server.chr.com/", "EmpWebServicePort"), EmpWebService.class, features);
    }

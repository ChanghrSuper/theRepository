    ...
    <script type="text/javascript">
        $(function(){
            $("#dg").datagrid({
                ...
                columns:[[
                    ...
                    {title:'Salary',field:'salary',width:270,sortable:true},
                    {title:'Age',field:'age',width:270,sortable:true},
                    {title:'Bir',field:'bir',width:270,sortable:true},
        ...
        function delEmpInfo(id){
            ...
            $.messager.confirm('提示', '确定要删除这条数据吗?', function(r){
                if (r){
                    //发送ajax请求删除数据
                    $.post("${pageContext.request.contextPath}/emp/delete",{"id":id},function(result){//原生ajaxjquery封装 获取的是js对象
                        //状态提示
                        //响应回来刷新刷新datagrid
                        $("#dg").datagrid('reload');
                    });
